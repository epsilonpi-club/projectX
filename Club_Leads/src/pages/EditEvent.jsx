...
export default function EditEvent() {
    ...
    useEffect(() => {
        if (event) {
            setFormData({
                ...
                venue: event.venue || '',
                expectedParticipants: event.totalSeats?.toString() || '',
                registrationDeadline: event.registrationDeadline || '',
                hasBudget: event.hasBudget || false,
                budgetAmount: event.budgetAmount?.toString() || '',
                budgetDescription: event.budgetDescription || '',
        ...
        return (
            <div className="propose-event-page">
                <div className="empty-state card">
                    ...
                    <p className="empty-state-description">The event you're trying to edit doesn't exist.</p>
    ...
    const handleSubmit = (e, status = 'draft') => {
        ...
        // Simulate API call
        setTimeout(() => {
            console.log('Event updated:', { ...formData, status });
            ...
            <div className="page-header">
                <div className="page-title-section">
                    ...
                    <div>
                        ...
                        <p className="page-subtitle">Update event details for {event.name}</p>
                    </div>
                </div>
            </div>
